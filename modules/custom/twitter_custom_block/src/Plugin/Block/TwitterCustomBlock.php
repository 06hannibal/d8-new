...
namespace Drupal\twitter_custom_block\Plugin\Block;
 ...
 *
 * @Block(
 *   id = "twitter_custom_block",
 *   admin_label = @Translation("Twitter Custom Block"),
 *   category = @Translation("Twitter"),
 * )
 */
class TwitterCustomBlock extends BlockBase {
  ...
  public function build() {
    ...
    $render['block'] = [
      ...
      '#attached' => [
        'library' => ['twitter_custom_block/widgets'],
      ],
    ];
